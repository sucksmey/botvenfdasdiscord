...
# Importa as configurações e a lista de tickets
from config import *
...
class Admin(commands.Cog):
    ...
    async def aprovar(self, interaction: discord.Interaction):
        ...
        await interaction.response.defer() # Adia a resposta para processar
